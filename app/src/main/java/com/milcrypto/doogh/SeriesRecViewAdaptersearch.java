...
public class SeriesRecViewAdaptersearch extends RecyclerView.Adapter<SeriesRecViewAdaptersearch.ViewHolder> {

    private List<New> newtv = new ArrayList<>();
    private Context context;

    public SeriesRecViewAdaptersearch(Context context) {
        this.context = context;
    }

    public SeriesRecViewAdaptersearch(List<New> newtv, Context context) {
        this.newtv = newtv;
        this.context = context;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
      ...
      try {
            ...
            holder.parent.setOnClickListener(view -> {
                ...
                Navigation.findNavController(view).navigate(R.id.action_search_to_show, bundle);
